...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'location_id', type: 'integer', nullable: true, example: 4),
        new OA\Property(property: 'instructor_id', type: 'integer', nullable: true, example: 12),
        new OA\Property(property: 'group_id', type: 'integer', nullable: true, example: 7),
        ...
        new OA\Property(property: 'location_text', type: 'string', nullable: true, example: 'Room A', description: 'Free-text fallback location label, used for ad-hoc events without a structured location_id.'),
        new OA\Property(
            property: 'location',
            nullable: true,
            description: 'Resolved location_id relation. Null when location_id is not set.',
            properties: [new OA\Property(property: 'id', type: 'integer', example: 4), new OA\Property(property: 'name', type: 'string', example: 'Sala Centrala')],
            type: 'object',
        ),
        new OA\Property(
            property: 'instructor',
            nullable: true,
            description: 'Resolved instructor_id relation (minimal fields only). Null when instructor_id is not set.',
            properties: [new OA\Property(property: 'id', type: 'integer', example: 12), new OA\Property(property: 'name', type: 'string', example: 'Ion Popescu')],
            type: 'object',
        ),
        new OA\Property(
            property: 'group',
            nullable: true,
            description: 'Resolved group_id relation. Null when group_id is not set.',
            properties: [new OA\Property(property: 'id', type: 'integer', example: 7), new OA\Property(property: 'name', type: 'string', example: 'Grupa avansati')],
            type: 'object',
        ),
        ...
        new OA\Property(property: 'payment_type', type: 'string', nullable: true, example: 'EUR', description: 'Currency code for payment_amount (e.g. EUR, RON). Required when requires_payment is true.'),
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'title', type: 'string', example: 'Yoga Class'),
        new OA\Property(property: 'category_id', type: 'integer', nullable: true, example: 3),
        new OA\Property(property: 'location_id', type: 'integer', nullable: true, example: 4, description: 'Must belong to the authenticated user organization.'),
        new OA\Property(property: 'instructor_id', type: 'integer', nullable: true, example: 12, description: 'Must belong to the authenticated user organization.'),
        new OA\Property(property: 'group_id', type: 'integer', nullable: true, example: 7, description: 'Must belong to the authenticated user organization.'),
        new OA\Property(property: 'description', type: 'string', nullable: true, example: 'Weekly yoga session.'),
        new OA\Property(property: 'location', type: 'string', nullable: true, example: 'Room A', description: 'Free-text fallback location label, used for ad-hoc events without a structured location_id.'),
        new OA\Property(property: 'start_time', type: 'string', example: '10:00'),
        new OA\Property(property: 'end_time', type: 'string', example: '11:00'),
        new OA\Property(property: 'recurrence_type', type: 'string', enum: ['once', 'weekly', 'monthly'], example: 'weekly'),
        new OA\Property(property: 'recurrence_days', type: 'array', nullable: true, items: new OA\Items(type: 'string'), example: ['monday', 'wednesday']),
        ...
        new OA\Property(property: 'payment_type', type: 'string', nullable: true, maxLength: 3, example: 'EUR', description: 'Currency code for payment_amount (e.g. EUR, RON). Required when requires_payment is true.'),
        new OA\Property(property: 'max_participants', type: 'integer', nullable: true, example: 20),
        new OA\Property(property: 'status', type: 'string', enum: ['active', 'inactive', 'cancelled'], example: 'active'),
    ],
    type: 'object',
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'apply_to_future_occurrences', type: 'boolean', nullable: true, example: false, description: 'When true, also mirrors this bulk add (best effort) onto the sibling scheduled future occurrences (today or later) of the same event.'),
    ],
    type: 'object',
)]
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'requires_payment', type: 'boolean', example: false, description: 'Informational only: mirrors the parent event requires_payment flag. Never blocks the bulk add.'),
        new OA\Property(
            property: 'future_occurrences_updated',
            type: 'array',
            description: 'Present only when the request had `apply_to_future_occurrences: true`. One entry per sibling scheduled future occurrence (today or later) of the same event, excluding the target occurrence.',
            items: new OA\Items(
                properties: [
                    new OA\Property(property: 'occurrence_id', type: 'integer', example: 124),
                    new OA\Property(property: 'occurrence_date', type: 'string', format: 'date', example: '2026-09-16'),
                    new OA\Property(property: 'added_user_ids', type: 'array', items: new OA\Items(type: 'integer'), example: [5, 7]),
                    new OA\Property(
                        property: 'skipped',
                        type: 'array',
                        items: new OA\Items(properties: [
                            new OA\Property(property: 'user_id', type: 'integer', example: 9),
                            new OA\Property(property: 'reason', type: 'string', enum: ['already_registered', 'missing_required_service', 'capacity_full', 'service_access_unavailable'], example: 'already_registered'),
                        ], type: 'object'),
                    ),
                ],
                type: 'object',
